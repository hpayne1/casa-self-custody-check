# Linkable resources (source of truth)

This file is a **link/CTA safety registry** for the content pipeline.
...
- **Exchange risk / self-custody framing**:
  ...
  - [Exchange failure: The security risk no one is talking about](https://blog.casa.io/exchange-failure/)
  - [Security lessons from the FTX collapse](https://blog.casa.io/crypto-security-lessons-from-the-ftx-collapse/)
  - [Should you trust a third party for bitcoin security?](https://blog.casa.io/should-you-trust-a-third-party-for-bitcoin-security/)

- **Multisig / multi-key basics**:
  - [What is a multisig wallet? Understanding the basics](https://blog.casa.io/an-introduction-to-multisig/)
  - [Casa multisig security: Mobile Key overview](https://blog.casa.io/casa-keymaster-security-mobile-key-overview/)
