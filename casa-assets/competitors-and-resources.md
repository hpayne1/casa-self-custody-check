# Competitors, peers, and resources (for CASA context)
...
| Company | Category | Notes (high level) |
|--------|----------|--------------------|
| CASA | Non-custodial self-custody vaults + support | Multi-key vaults, inheritance, white-glove support tiers. |
| Unchained | Collaborative custody / multisig services | Often positioned around collaborative multisig and services for bitcoiners. |
| Swan | Bitcoin services + vault offering | Encourages self-custody; offers vault-style product. |

## Hardware wallets (tools users may use alongside CASA)

| Tool | Notes |
|------|------|
| Ledger | Hardware wallet (general-purpose). |
| Trezor | Hardware wallet. |
| Coldcard | Bitcoin-focused hardware wallet. |
| Blockstream Jade | Bitcoin-focused hardware wallet. |

## Software wallets / self-custody tooling (adjacent)

| Tool | Notes |
|------|------|
| Sparrow Wallet | Bitcoin wallet focused on power users and UTXO control. |
| Electrum | Bitcoin wallet with a long history. |
| BlueWallet | Bitcoin wallet (mobile) commonly used for smaller amounts. |
...
- Opportunistic ads / keyword targeting
- Blame, mockery, or tribal pile-ons
